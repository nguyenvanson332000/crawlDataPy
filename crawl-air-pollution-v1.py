...
def selenium():
	...
	o3_click = browser.find_element_by_xpath("/html/body/div[7]/center[3]/div/div[2]/div[3]/div[2]/center/ul/li[2]")
	sleep(1)
	...
	no2_click = browser.find_element_by_xpath("/html/body/div[7]/center[3]/div/div[2]/div[3]/div[2]/center/ul/li[3]")
	sleep(1)
	...
	so2_click = browser.find_element_by_xpath("/html/body/div[7]/center[3]/div/div[2]/div[3]/div[2]/center/ul/li[4]")
	sleep(1)
	...
	co_click = browser.find_element_by_xpath("/html/body/div[7]/center[3]/div/div[2]/div[3]/div[2]/center/ul/li[5]")
	sleep(1)
	...
	a = {'date': date_list, 'PM25': pm25, 'O3': o3, 'NO2': no2, 'SO2': so2, 'CO': co}
	df = pd.DataFrame.from_dict(a, orient='index')
	df = df.transpose()
	dataset = pd.DataFrame(data=df)
	dataset.to_csv('crawl.csv')
	browser.close() # crawl xong tự tắt
